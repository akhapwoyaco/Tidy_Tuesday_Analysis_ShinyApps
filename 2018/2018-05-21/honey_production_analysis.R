...
honey_production <- read_csv("honeyproduction.csv")
...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      fluidRow(
        plotOutput(outputId = 'honey_plot', width = '90%', height = 400)),
      fluidRow(
    ...
    tabPanel(
      ...
      fluidRow(
        column(6, 
        plotOutput(outputId = 'honey_plot_tab_2', width = '100%')),
        column(6, 
        plotOutput(outputId = 'usa_states_corr_2', width = '100%'))),
      fluidRow(
